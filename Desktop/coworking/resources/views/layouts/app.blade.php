...
<head>
    ...
    <title>@yield('title', 'CoWork') — Espace de Coworking</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* Gradient text */
        .gradient-text {
            background: linear-gradient(135deg, var(--accent), #7c5fcf);
...
<aside class="sidebar" id="sidebar">
    <div style="padding: 20px 16px;">
        ...
        <a href="{{ route('dashboard') }}" style="display: flex; align-items: center; gap: 10px; margin-bottom: 24px; text-decoration: none;">
            <div style="background: linear-gradient(135deg, #4f7ef7, #7c5fcf); border-radius: 11px; width: 38px; height: 38px; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
            ...
            <span style="font-family: 'Poppins', sans-serif; font-size: 20px; font-weight: 800; color: var(--text);">Co<span class="gradient-text">Work</span></span>
        </a>
        ...
        <div style="background: var(--surface3); border-radius: 10px; padding: 10px 12px; margin-bottom: 20px; border: 1px solid var(--border);">
            <div style="display: flex; align-items: center; gap: 10px;">
                <div style="width: 34px; height: 34px; border-radius: 8px; background: linear-gradient(135deg, #4f7ef7, #7c5fcf); display: flex; align-items: center; justify-content: center; font-weight: 700; color: white; font-size: 13px; flex-shrink: 0;">
                ...
                <div style="min-width: 0;">
                    ...
                    <div style="font-size: 11px; color: var(--text-muted);">{{ Auth::user()->isAdmin() ? 'Administrateur' : 'Membre' }}</div>
                </div>
            </div>
        </div>
        ...
        <nav>
            ...
            @if(Auth::user()->isAdmin())
            <div class="nav-label" style="margin-top: 18px;">Administration</div>
